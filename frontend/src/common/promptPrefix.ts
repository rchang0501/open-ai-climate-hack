...
const promptPrefix = (inputCode: string) => {
    ...
    Python:
    for nCounter in range(67, 70):
        if int_variable == nCounter:
            HR1 = HR1.off
            break
